...
echo "AntCom_mask_L" `fslstats MASK/Mask_AntCom_mask_L.mif -V` >> Overview_volumes_All.txt
echo "AntCom_mask_R " `fslstats MASK/Mask_AntCom_mask_R.mif -V` >> Overview_volumes_All.txt
echo "Caudate_mask_L" `fslstats MASK/Mask_Caudate_mask_L.mif -V` >> Overview_volumes_All.txt
echo "Caudate_mask_R " `fslstats MASK/Mask_Caudate_mask_R.mif -V` >> Overview_volumes_All.txt
echo "GPe_mask_L" `fslstats MASK/Mask_GPe_mask_L.mif -V` >> Overview_volumes_All.txt
echo "GPe_mask_R " `fslstats MASK/Mask_GPe_mask_R.mif -V` >> Overview_volumes_All.txt
echo "GPi_mask_L" `fslstats MASK/Mask_GPi_mask_L.mif -V` >> Overview_volumes_All.txt
echo "GPi_mask_R " `fslstats MASK/Mask_GPi_mask_R.mif -V` >> Overview_volumes_All.txt
echo "IntCap_mask_L" `fslstats MASK/Mask_IntCap_mask_L.mif -V` >> Overview_volumes_All.txt
echo "IntCap_mask_R " `fslstats MASK/Mask_IntCap_mask_R.mif -V` >> Overview_volumes_All.txt
echo "IntThalAdh_mask_L" `fslstats MASK/Mask_IntThalAdh_mask_L.mif -V` >> Overview_volumes_All.txt
echo "IntThalAdh_mask_R " `fslstats MASK/Mask_IntThalAdh_mask_R.mif -V` >> Overview_volumes_All.txt
echo "LocCoer_mask_R " `fslstats MASK/Mask_LocCoer_mask_R.mif -V` >> Overview_volumes_All.txt
echo "LocCoer_mask_L" `fslstats MASK/Mask_LocCoer_mask_L.mif -V` >> Overview_volumes_All.txt
echo "Putamen_mask_L" `fslstats MASK/Mask_Putamen_mask_L.mif -V` >> Overview_volumes_All.txt
echo "Putamen_mask_R " `fslstats MASK/Mask_Putamen_mask_R.mif -V` >> Overview_volumes_All.txt
echo "RedNucl_mask_L" `fslstats MASK/Mask_RedNucl_mask_L.mif -V` >> Overview_volumes_All.txt
echo "RedNucl_mask_R " `fslstats MASK/Mask_RedNucl_mask_R.mif -V` >> Overview_volumes_All.txt
echo "STN_mask_L" `fslstats MASK/Mask_STN_mask_L.mif -V` >> Overview_volumes_All.txt
echo "STN_mask_R " `fslstats MASK/Mask_STN_mask_R.mif -V` >> Overview_volumes_All.txt
echo "SubNig_mask_L" `fslstats MASK/Mask_SubNig_mask_L.mif -V` >> Overview_volumes_All.txt
echo "SubNig_mask_R " `fslstats MASK/Mask_SubNig_mask_R.mif -V` >> Overview_volumes_All.txt
echo "SubLentIntCap_mask_L" `fslstats MASK/Mask_SubLentIntCap_mask_L.mif -V` >> Overview_volumes_All.txt
echo "SubLentIntCap_mask_R " `fslstats MASK/Mask_SubLentIntCap_mask_R.mif -V` >> Overview_volumes_All.txt
echo "Thalamus_mask_L" `fslstats MASK/Mask_Thalamus_mask_L.mif -V` >> Overview_volumes_All.txt
echo "Thalamus_mask_R " `fslstats MASK/Mask_Thalamus_mask_R.mif -V` >> Overview_volumes_All.txt
echo "VentPal_mask_L " `fslstats MASK/Mask_VentPal_mask_L.mif -V` >> Overview_volumes_All.txt
echo "VentPal_mask_R " `fslstats MASK/Mask_VentPal_mask_R.mif -V` >> Overview_volumes_All.txt
...
echo "AntCom_mask_L" `fslstats MASK/Mask_AntCom_mask_L.mif -V` >> Overview_volumes_L.txt
echo "Caudate_mask_L" `fslstats MASK/Mask_Caudate_mask_L.mif -V` >> Overview_volumes_L.txt
echo "GPe_mask_L" `fslstats MASK/Mask_GPe_mask_L.mif -V` >> Overview_volumes_L.txt
echo "GPi_mask_L" `fslstats MASK/Mask_GPi_mask_L.mif -V` >> Overview_volumes_L.txt
echo "IntCap_mask_L" `fslstats MASK/Mask_IntCap_mask_L.mif -V` >> Overview_volumes_L.txt
echo "IntThalAdh_mask_L" `fslstats MASK/Mask_IntThalAdh_mask_L.mif -V` >> Overview_volumes_L.txt
echo "LocCoer_mask_L" `fslstats MASK/Mask_LocCoer_mask_L.mif -V` >> Overview_volumes_L.txt
echo "Putamen_mask_L" `fslstats MASK/Mask_Putamen_mask_L.mif -V` >> Overview_volumes_L.txt
echo "RedNucl_mask_L" `fslstats MASK/Mask_RedNucl_mask_L.mif -V` >> Overview_volumes_L.txt
echo "STN_mask_L" `fslstats MASK/Mask_STN_mask_L.mif -V` >> Overview_volumes_L.txt
echo "SubNig_mask_L" `fslstats MASK/Mask_SubNig_mask_L.mif -V` >> Overview_volumes_L.txt
echo "SubLentIntCap_mask_L" `fslstats MASK/Mask_SubLentIntCap_mask_L.mif -V` >> Overview_volumes_L.txt
echo "Thalamus_mask_L" `fslstats MASK/Mask_Thalamus_mask_L.mif -V` >> Overview_volumes_L.txt
echo "VentPal_mask_L " `fslstats MASK/Mask_VentPal_mask_L.mif -V` >> Overview_volumes_L.txt
...
echo "AntCom_mask_R " `fslstats MASK/Mask_AntCom_mask_R.mif -V` >> Overview_volumes_R.txt
echo "Caudate_mask_R " `fslstats MASK/Mask_Caudate_mask_R.mif -V` >> Overview_volumes_R.txt
echo "GPe_mask_R " `fslstats MASK/Mask_GPe_mask_R.mif -V` >> Overview_volumes_R.txt
echo "GPi_mask_R " `fslstats MASK/Mask_GPi_mask_R.mif -V` >> Overview_volumes_R.txt
echo "IntCap_mask_R " `fslstats MASK/Mask_IntCap_mask_R.mif -V` >> Overview_volumes_R.txt
echo "IntThalAdh_mask_R " `fslstats MASK/Mask_IntThalAdh_mask_R.mif -V` >> Overview_volumes_R.txt
echo "LocCoer_mask_R " `fslstats MASK/Mask_LocCoer_mask_R.mif -V` >> Overview_volumes_R.txt
echo "Putamen_mask_R " `fslstats MASK/Mask_Putamen_mask_R.mif -V` >> Overview_volumes_R.txt
echo "RedNucl_mask_R " `fslstats MASK/Mask_RedNucl_mask_R.mif -V` >> Overview_volumes_R.txt
echo "STN_mask_R " `fslstats MASK/Mask_STN_mask_R.mif -V` >> Overview_volumes_R.txt
echo "SubNig_mask_R " `fslstats MASK/Mask_SubNig_mask_R.mif -V` >> Overview_volumes_R.txt
echo "SubLentIntCap_mask_R " `fslstats MASK/Mask_SubLentIntCap_mask_R.mif -V` >> Overview_volumes_R.txt
echo "Thalamus_mask_R " `fslstats MASK/Mask_Thalamus_mask_R.mif -V` >> Overview_volumes_R.txt
echo "VentPal_mask_R " `fslstats MASK/Mask_VentPal_mask_R.mif -V` >> Overview_volumes_R.txt
...
# echo "AntCom_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_AntCom_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "AntCom_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_AntCom_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "Caudate_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Caudate_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "Caudate_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Caudate_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "GPe_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPe_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "GPe_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPe_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "GPi_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPi_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "GPi_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPi_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "IntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntCap_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "IntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntCap_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "IntThalAdh_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntThalAdh_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "IntThalAdh_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntThalAdh_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "LocCoer_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_LocCoer_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "LocCoer_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_LocCoer_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "Putamen_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Putamen_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "Putamen_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Putamen_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "RedNucl_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_RedNucl_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "RedNucl_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_RedNucl_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "STN_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_STN_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "STN_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_STN_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "SubNig_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubNig_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "SubNig_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubNig_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "SubLentIntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubLentIntCap_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "SubLentIntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubLentIntCap_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "Thalamus_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Thalamus_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "Thalamus_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Thalamus_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "VentPal_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_VentPal_mask_L.mif -V -M -S` >> Overview_T2_values_All.txt
# echo "VentPal_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_VentPal_mask_R.mif -V -M -S` >> Overview_T2_values_All.txt
# 
...
# echo "AntCom_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_AntCom_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "Caudate_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Caudate_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "GPe_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPe_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "GPi_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPi_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "IntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntCap_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "IntThalAdh_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntThalAdh_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "LocCoer_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_LocCoer_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "Putamen_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Putamen_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "RedNucl_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_RedNucl_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "STN_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_STN_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "SubNig_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubNig_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "SubLentIntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubLentIntCap_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "Thalamus_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Thalamus_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# echo "VentPal_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_VentPal_mask_L.mif -V -M -S` >> Overview_T2_values_L.txt
# 
...
# echo "AntCom_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_AntCom_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "Caudate_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Caudate_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "GPe_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPe_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "GPi_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_GPi_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "IntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntCap_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "IntThalAdh_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_IntThalAdh_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "LocCoer_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_LocCoer_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "Putamen_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Putamen_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "RedNucl_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_RedNucl_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "STN_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_STN_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "SubNig_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubNig_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "SubLentIntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_SubLentIntCap_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "Thalamus_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_Thalamus_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
# echo "VentPal_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k MASK/Mask_VentPal_mask_R.mif -V -M -S` >> Overview_T2_values_R.txt
