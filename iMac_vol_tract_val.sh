...
echo "AntCom_mask_L" `fslstats ERODE/Mask_AntCom_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "AntCom_mask_R " `fslstats ERODE/Mask_AntCom_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "Caudate_mask_L" `fslstats ERODE/Mask_Caudate_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "Caudate_mask_R " `fslstats ERODE/Mask_Caudate_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "GPe_mask_L" `fslstats ERODE/Mask_GPe_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "GPe_mask_R " `fslstats ERODE/Mask_GPe_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "GPi_mask_L" `fslstats ERODE/Mask_GPi_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "GPi_mask_R " `fslstats ERODE/Mask_GPi_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "IntCap_mask_L" `fslstats ERODE/Mask_IntCap_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "IntCap_mask_R " `fslstats ERODE/Mask_IntCap_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "IntThalAdh_mask_L" `fslstats ERODE/Mask_IntThalAdh_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "IntThalAdh_mask_R " `fslstats ERODE/Mask_IntThalAdh_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "LocCoer_mask_R " `fslstats ERODE/Mask_LocCoer_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "LocCoer_mask_L" `fslstats ERODE/Mask_LocCoer_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "Putamen_mask_L" `fslstats ERODE/Mask_Putamen_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "Putamen_mask_R " `fslstats ERODE/Mask_Putamen_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "RedNucl_mask_L" `fslstats ERODE/Mask_RedNucl_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "RedNucl_mask_R " `fslstats ERODE/Mask_RedNucl_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "STN_mask_L" `fslstats ERODE/Mask_STN_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "STN_mask_R " `fslstats ERODE/Mask_STN_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "SubNig_mask_L" `fslstats ERODE/Mask_SubNig_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "SubNig_mask_R " `fslstats ERODE/Mask_SubNig_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "SubLentIntCap_mask_L" `fslstats ERODE/Mask_SubLentIntCap_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "SubLentIntCap_mask_R " `fslstats ERODE/Mask_SubLentIntCap_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "Thalamus_mask_L" `fslstats ERODE/Mask_Thalamus_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "Thalamus_mask_R " `fslstats ERODE/Mask_Thalamus_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "VentPal_mask_L " `fslstats ERODE/Mask_VentPal_mask_L_Painted.nii.gz -V` >> Overview_volumes_All.txt
echo "VentPal_mask_R " `fslstats ERODE/Mask_VentPal_mask_R_Painted.nii.gz -V` >> Overview_volumes_All.txt
...
echo "AntCom_mask_L" `fslstats ERODE/Mask_AntCom_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "Caudate_mask_L" `fslstats ERODE/Mask_Caudate_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "GPe_mask_L" `fslstats ERODE/Mask_GPe_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "GPi_mask_L" `fslstats ERODE/Mask_GPi_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "IntCap_mask_L" `fslstats ERODE/Mask_IntCap_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "IntThalAdh_mask_L" `fslstats ERODE/Mask_IntThalAdh_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "LocCoer_mask_L" `fslstats ERODE/Mask_LocCoer_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "Putamen_mask_L" `fslstats ERODE/Mask_Putamen_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "RedNucl_mask_L" `fslstats ERODE/Mask_RedNucl_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "STN_mask_L" `fslstats ERODE/Mask_STN_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "SubNig_mask_L" `fslstats ERODE/Mask_SubNig_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "SubLentIntCap_mask_L" `fslstats ERODE/Mask_SubLentIntCap_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "Thalamus_mask_L" `fslstats ERODE/Mask_Thalamus_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
echo "VentPal_mask_L " `fslstats ERODE/Mask_VentPal_mask_L_Painted.nii.gz -V` >> Overview_volumes_L.txt
...
echo "AntCom_mask_R " `fslstats ERODE/Mask_AntCom_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "Caudate_mask_R " `fslstats ERODE/Mask_Caudate_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "GPe_mask_R " `fslstats ERODE/Mask_GPe_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "GPi_mask_R " `fslstats ERODE/Mask_GPi_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "IntCap_mask_R " `fslstats ERODE/Mask_IntCap_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "IntThalAdh_mask_R " `fslstats ERODE/Mask_IntThalAdh_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "LocCoer_mask_R " `fslstats ERODE/Mask_LocCoer_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "Putamen_mask_R " `fslstats ERODE/Mask_Putamen_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "RedNucl_mask_R " `fslstats ERODE/Mask_RedNucl_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "STN_mask_R " `fslstats ERODE/Mask_STN_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "SubNig_mask_R " `fslstats ERODE/Mask_SubNig_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "SubLentIntCap_mask_R " `fslstats ERODE/Mask_SubLentIntCap_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "Thalamus_mask_R " `fslstats ERODE/Mask_Thalamus_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
echo "VentPal_mask_R " `fslstats ERODE/Mask_VentPal_mask_R_Painted.nii.gz -V` >> Overview_volumes_R.txt
...
echo "AntCom_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_AntCom_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "AntCom_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_AntCom_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "Caudate_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Caudate_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "Caudate_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Caudate_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "GPe_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPe_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "GPe_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPe_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "GPi_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPi_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "GPi_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPi_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "IntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntCap_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "IntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntCap_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "IntThalAdh_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntThalAdh_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "IntThalAdh_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntThalAdh_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "LocCoer_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_LocCoer_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "LocCoer_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_LocCoer_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "Putamen_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Putamen_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "Putamen_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Putamen_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "RedNucl_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_RedNucl_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "RedNucl_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_RedNucl_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "STN_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_STN_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "STN_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_STN_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "SubNig_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubNig_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "SubNig_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubNig_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "SubLentIntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubLentIntCap_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "SubLentIntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubLentIntCap_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "Thalamus_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Thalamus_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "Thalamus_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Thalamus_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "VentPal_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_VentPal_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
echo "VentPal_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_VentPal_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_All.txt
...
echo "AntCom_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_AntCom_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "Caudate_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Caudate_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "GPe_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPe_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "GPi_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPi_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "IntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntCap_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "IntThalAdh_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntThalAdh_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "LocCoer_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_LocCoer_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "Putamen_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Putamen_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "RedNucl_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_RedNucl_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "STN_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_STN_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "SubNig_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubNig_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "SubLentIntCap_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubLentIntCap_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "Thalamus_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Thalamus_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
echo "VentPal_mask_L" `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_VentPal_mask_L_Painted.nii.gz -V -M -S` >> Overview_T2_values_L.txt
...
echo "AntCom_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_AntCom_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "Caudate_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Caudate_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "GPe_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPe_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "GPi_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_GPi_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "IntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntCap_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "IntThalAdh_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_IntThalAdh_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "LocCoer_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_LocCoer_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "Putamen_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Putamen_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "RedNucl_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_RedNucl_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "STN_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_STN_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "SubNig_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubNig_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "SubLentIntCap_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_SubLentIntCap_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "Thalamus_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_Thalamus_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt
echo "VentPal_mask_R " `fslstats ../../GRE/S0T2_output/S0T2_exvivo/ExpT2Dec.T2.nii.gz -k ERODE/Mask_VentPal_mask_R_Painted.nii.gz -V -M -S` >> Overview_T2_values_R.txt

# Create tracts based on masks with SD STREAM algorithm - will be done with the script DSRI_tckgen.sh
# tckgen DWI_FOD.mif TRACTS/Tracts_AntCom_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_AntCom_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_AntCom_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_AntCom_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_Caudate_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_Caudate_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_Caudate_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_Caudate_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_GPe_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_GPe_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_GPe_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_GPe_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_GPi_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_GPi_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_GPi_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_GPi_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_IntCap_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_IntCap_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_IntCap_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_IntCap_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_IntThalAdh_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_IntThalAdh_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_IntThalAdh_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_IntThalAdh_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_LocCoer_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_LocCoer_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_LocCoer_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_LocCoer_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_Putamen_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_Putamen_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_Putamen_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_Putamen_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_RedNucl_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_RedNucl_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_RedNucl_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_RedNucl_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_STN_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_STN_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_STN_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_STN_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_SubNig_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_SubNig_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_SubNig_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_SubNig_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_SubLentIntCap_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_SubLentIntCap_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_SubLentIntCap_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_SubLentIntCap_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_Thalamus_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_Thalamus_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_Thalamus_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_Thalamus_mask_R_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_VentPal_mask_L.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_VentPal_mask_L_Painted.nii.gz -select 100000
# tckgen DWI_FOD.mif TRACTS/Tracts_VentPal_mask_R.tck -algorithm SD_STREAM -mask DWI_Mask_Painted.mif -seed_image ERODE/Mask_VentPal_mask_R_Painted.nii.gz -select 100000
